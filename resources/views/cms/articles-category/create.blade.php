  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="{{ route('admin.articleCategory.store')}}" method="post" id="createForm">
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" placeholder="Nama kategori artikel" name="name" autocomplete="off">
                </div>
              </div>
              <!-- /.col -->
            </div>
