                ...
                <div class="card-body">
                    ...
                    @endif
                        <div class="form-group">
                            ...
                            <input type="hidden" name="hiddenMainImage" value="{{ !empty($artists) ? 'Update' : 'New'}}">
                        </div>
                        <div class="form-group">
...
@if(isset($artists))
<script>
  const tmpImg = "{{ $artists->image }}";
  if(tmpImg != "#"){
    const img = "{{ env('IMAGE_PATH', 'http://127.0.0.1:8000/storage/') }}"+"{{$artists->image}}";
    mainPond.server = {
